    ...
    <table id="catalog-datatable" class="table table-borderless table-hover">
        <thead>
            <tr class="active text-center">
                <th>ID</th><th>{{ trans('catalog.code') }}</th><th>{{ trans('catalog.name') }}</th><th>{{ trans('catalog.organization_id') }}</th><th>Acciones</th>
            </tr>
        </thead>
        <tbody>
        @foreach($catalog as $item)
            <tr>
                <td>{{ $item->id }}</td>
                <td>{{ $item->code }}</td><td><a href="javascript:view({{$item->id}});">{{ $item->name }}</a></td><td>{{ $item->organization->name }}</td>
                <td>
