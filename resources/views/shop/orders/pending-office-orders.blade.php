...
@section('title')
Solicitudes de mis oficinas - ARB2B
@endsection
...
<ol class="breadcrumb">
    ...
    <li><a href="#">Solicitudes de mis oficinas</a></li>
</ol>
<h4>Solicitudes de mis oficinas</h4>
<br>
...
<form id="order-details" action="{{route('order.details')}}" method="GET">
    ...
    <input type="hidden" name="url" value="shop/pending-office-orders">
