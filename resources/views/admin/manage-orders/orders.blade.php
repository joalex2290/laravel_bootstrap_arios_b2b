...
<table id="orders-datatable" class="table table-hover table-condensed">
    <thead>
        <tr class="active">
            ...
            <th class="hidden-xs text-center">F. Pedido</th>
            <th class="hidden-xs text-center">F. Despacho</th>
            <th class="hidden-xs text-center">F. Entrega</th>
    ...
    <tbody>
        ...
        <tr>
            <td class="text-right small">{{$order->doc_num}}</td>
...
<form id="order-details" action="{{route('manage-order-details')}}" method="GET">
    <input type="hidden" name="id" value="">
    <input type="hidden" name="url" value="/admin/manage-orders">
