...
<div class="form-group {{ $errors->has('code') ? 'has-error' : ''}}">
    {!! Form::label('code', trans('office.code'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    {!! Form::label('name', trans('office.name'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
    {!! Form::label('type', trans('office.type'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('phone') ? 'has-error' : ''}}">
    {!! Form::label('phone', trans('office.phone'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('address') ? 'has-error' : ''}}">
    {!! Form::label('address', trans('office.address'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group{{ $errors->has('department_id') ? ' has-error' : '' }}">
    {!! Form::label('department_id', 'Departamento', ['class' => 'col-md-3 control-label']) !!}
    <div id="departments" class="col-md-6">
        {!! Form::select('department_id', $departments, isset($office_department) ? $office_department : [], ['class' => 'form-control', 'onchange' => 'getdepartmentCities()']) !!}
    </div>
</div>
<div class="form-group{{ $errors->has('city_id') ? ' has-error' : '' }}">
    {!! Form::label('city_id', trans('office.city_id'), ['class' => 'col-md-3 control-label']) !!}
    <div id="cities" class="col-md-6">
    </div>
</div>
<div class="form-group {{ $errors->has('postal_code') ? 'has-error' : ''}}">
    {!! Form::label('postal_code', trans('office.postal_code'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('contact_name') ? 'has-error' : ''}}">
    {!! Form::label('contact_name', trans('office.contact_name'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('contact_phone') ? 'has-error' : ''}}">
    {!! Form::label('contact_phone', trans('office.contact_phone'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('contact_cellphone') ? 'has-error' : ''}}">
    {!! Form::label('contact_cellphone', trans('office.contact_cellphone'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('contact_email') ? 'has-error' : ''}}">
    {!! Form::label('contact_email', trans('office.contact_email'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('credit_limit') ? 'has-error' : ''}}">
    {!! Form::label('credit_limit', trans('office.credit_limit'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('avatar_url') ? 'has-error' : ''}}">
    {!! Form::label('avatar_url', trans('office.avatar_url'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
...
<div class="form-group {{ $errors->has('active') ? 'has-error' : ''}}">
    {!! Form::label('active', trans('office.active'), ['class' => 'col-md-3 control-label']) !!}
    <div class="col-md-6">
