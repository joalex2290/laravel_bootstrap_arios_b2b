    ...
    <div class="tab-content">
        <div id="tab-quote" @if($tab == 1) class="tab-pane active" @else class="tab-pane" @endif >
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>{{$quote->reviewed_at}}</td>
                </tr>
                <tr>
                    <td>Fecha Despacho:</td>
                    <td>{{$quote->dispatched_at}}</td>
                </tr>
                <tr>
                    <td>Fecha Entrega:</td>
                    <td>{{$quote->delivered_at}}</td>
                </tr>
                <tr>
        ...
        <div id="tab-shipping" class="tab-pane">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    <td>Pais:</td>
                    <td>{{$quote->city->department->country->name}}</td>
                </tr>
            </tbody>
        </table>
    </div>
