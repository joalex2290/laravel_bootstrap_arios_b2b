...
@section('title')
{{ trans('department.crud_name') }} - ARB2B
@endsection
...
<ol class="breadcrumb">
  ...
  <li><a href="#">{{ trans('department.crud_name') }}</a></li>
</ol>
<h4>{{ trans('department.crud_name') }}      
...
<div class="table-responsive">
    <table id="department-datatable" class="table table-borderless table-hover">
        <thead>
            <tr class="active text-center">
                <th>ID</th><th>{{ trans('department.code') }}</th><th>{{ trans('department.name') }}</th><th>{{ trans('department.country_id') }}</th><th>Acciones</th>
            </tr>
        </thead>
        <tbody>
