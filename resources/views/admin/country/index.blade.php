...
<ol class="breadcrumb">
  ...
  <li><a href="#">{{ trans('country.crud_name') }}</a></li>
</ol>
<h4>{{ trans('country.crud_name') }}      
...
<div class="table-responsive">
    <table id="country-datatable" class="table table-borderless table-hover">
        <thead>
            <tr class="active text-center">
                <th>ID</th><th>{{ trans('country.code') }}</th><th>{{ trans('country.name') }}</th><th>Acciones</th>
            </tr>
        </thead>
        <tbody>
        @foreach($country as $item)
            <tr>
                <td>{{ $item->id }}</td>
                <td>{{ $item->code }}</td><td><a href="javascript:view({{$item->id}});">{{ $item->name }}</a></td>
                <td>
