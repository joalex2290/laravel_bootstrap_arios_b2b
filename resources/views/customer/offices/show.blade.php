...
<h4><strong><a href="{{url('customer/users')}}">Empleados</a></strong></h4>
<p class="">
    @if($office->users()->exists())
    @foreach($office->users as $user)
    <span class="label label-as-badge label-primary">{{$user->name}}</span>
    @endforeach
    @else
    <span class="label label-as-badge label-default">Sin empleados</span>
    @endif
</p>
<hr>
<h4><strong><a href="{{url('customer/add-catalogs-to-office')}}">Catalogos</a></strong></h4>
<p class="">
...
<div class="col-md-8">
    <div class="pull-right">
        <a href="{{url('customer/offices/'.$office->id.'/edit')}}" class="btn btn-warning btn-sm" title="Editar">
