...
<ol class="breadcrumb">
  ...
  <li><a href="#">{{ trans('carrier.crud_name') }}</a></li>
</ol>
<h4>{{ trans('carrier.crud_name') }}      
...
<div class="table-responsive">
    <table id="carrier-datatable" class="table table-borderless table-hover">
        <thead>
            <tr class="active text-center">
                <th>ID</th><th>{{ trans('carrier.name') }}</th><th>{{ trans('carrier.label') }}</th><th>{{ trans('carrier.website') }}</th><th>Acciones</th>
            </tr>
        </thead>
        <tbody>
        @foreach($carrier as $item)
            <tr>
                <td>{{ $item->id }}</td>
                <td><a href="javascript:view({{$item->id}});">{{ $item->name }}</a></td><td>{{ $item->label }}</td><td>{{ $item->website }}</td>
                <td>
