        ...
        <ul class="list-inline pull-right">
            ...
            <li>
                ...
                <div class="btn-group pull-right">
                    ...
                    <a type="button" href="{{route('order.reject')}}?order_id={{$order->id}}&url={{url($url)}}&tab=1" onclick="return confirm('Confirma rechazar el pedido?')" class="btn btn-danger">
...
<form class="form-horizontal" action="{{route('order.add-customer-log')}}" method="POST" enctype="multipart/form-data">
    {{csrf_field()}}
